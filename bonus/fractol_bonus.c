...
/*   Updated: 2025/02/25 14:51:16 by mel-moud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int get_color(int i, t_fractol *fract)
{
    ...
    if (fract->color_shift == 0)
        return (get_rgb(255 * pow(t, 0.3), 200 * pow(t, 0.5), 50 * pow(1 - t, 2), 255));
    else if (fract->color_shift == 1) 
        return (get_rgb(50 * (1 - t), 100 * pow(t, 0.6), 255 * pow(t, 0.3), 255));
    else if (fract->color_shift == 2)
        return (get_rgb(200 * pow(t, 0.5), 50 * (1 - t), 100 * pow(1 - t, 0.7), 255));
